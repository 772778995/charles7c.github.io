...
export const themeConfig: DefaultTheme.Config = {
  ...
  // 编辑链接配置
  editLink: {
    pattern: 'https://github.com/772778995/charles7c.github.io/edit/main/docs/:path',
    text: '不妥之处，敬请雅正'
  },
  // 搜索配置（二选一）
  search: {
  ...
  // 导航栏右侧社交链接配置
  socialLinks: [
    { icon: 'github', link: 'https://github.com/772778995/charles7c.github.io' }
  ],

  // 自定义扩展: 文章元数据配置
  // @ts-ignore
  articleMetadataConfig: {
    author: 'Hocho', // 文章全局默认作者名称
  ...
  footerConfig: {
    ...
    copyright: `Copyright © 2021-${new Date().getFullYear()} Hocho` // 版权信息
  }
}